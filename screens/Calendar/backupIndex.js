...
// import PopAttendance from './popAttendance';
// import AbsenceAttendance from './absenceAttendance';
...
//           ev.class_ids.includes(userInfo.class_id[selected_class_index]) && ev.status != "inactive"
//       );
...
//                 />
//                 <Pagination
//                   dotsLength={carousel_list.length > 8 ? 8 : carousel_list.length}
...
//                   height: configs.heightWithStatusBar / 3.7,
//                   width: configs.width,
//                 }}>
//                 <View
//                   style={{
...
//                 zIndex: 1,
//                 marginTop: this.props.userInfo.user_type == 'parent' ? -10 : 0,
//                 paddingBottom: 10,
//               }}>
//               <Calendar
...
//             {this._getStatus() == 'undefined' && this.renderEventsEmpty().length == 0 &&  this._getRegisteredEventsByDate().length == 0 ?
//                 <View
//                   style={{
//                     flex: 1,
//                     justifyContent: 'center',
...
//                             borderRadius: 99999999,
//                           }}
//                           onPress={this._onRegisterAction}>
//                           <Text
//                             style={{
//                               color: configs.colors.white,
//                               fontFamily: configs.fontFamily.OPS700,
...
//                               textAlign: 'center',
//                             }}>
//                             {this.state.selectedEvent.isRegistered 
//                               ? 'Attending'
//                               : 'For Info/ Sign up'}
//                           </Text>
//                         </TouchableOpacity>
...
//     setParentEventRegister: (event_id, parent_id, handleCallback) =>
//       dispatch(
//         homeAction.setParentEventRegister(event_id, parent_id, handleCallback),
//       ),
//     fetchAllAttendanceForDotsCalendar: (
//       student_id,
//       start_date,
